...
const char *SymbolEntry::getKindCString() const { 
    if(kind == KindEnum::kProgramKind)
        return "Program";
    else if(kind == KindEnum::kFunctionKind){
        return "Function";
    }
    else if(kind == KindEnum::kParameterKind){
        return "Parameter";
    }
    else if(kind == KindEnum::kVariableKind){
        return "Variable";
    }
    else if(kind == KindEnum::kLoopVarKind){
        return "LoopVar";
    }
    else if(kind == KindEnum::kConstantKind){
        return "Constant";
    }
}
